...
```{r fig.cap = "Figure 1. Histogram of daily bike ridership, separated into thirds.", echo = FALSE, out.width = "700px"}
...
```{r fig.cap = "Figure 2. Daily Ridership over the course of two years, coloured by season.  Black dotted line is a 15 point moving average acting as a smoother to observe trends with less noise.", echo = FALSE, out.width = "700px"}
...
```{r echo=FALSE, fig.cap="Figure 3. Accuracy Score with various `max_depth` values during Cross validation", out.width = "500px"}
...
```{r fig.cap = "Figure 5. Feature importance rated by Gini Value.", echo = FALSE, out.width = "500px"}
