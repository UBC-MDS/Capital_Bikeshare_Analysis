...
data/cleaned_day.csv : src/load_csv.R data/day.csv
	Rscript src/load_csv.R data/day.csv data/cleaned_day.csv

result/summarised_data.csv report/img/accuracy.png report/img/dtree.png result/tree_summary.csv : src/summarise_data.py data/cleaned_day.csv
...
report/img/plot_atemp_crossplot.png  report/img/plot_rider_by_date.png  report/img/plot_ridership_histo.png  report/img/plot_weather_rentalship_heatmap.png : src/eda_plots.R data/cleaned_day.csv
